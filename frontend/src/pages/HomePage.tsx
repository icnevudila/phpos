...
function SectionFallback(): JSX.Element {
  return <div className="h-32 animate-pulse rounded-2xl bg-slate-100/80" />;
}
...
function DifferentiatorMiniMock({ type }: { type: string }) {
  const glassCls = "bg-white/95 backdrop-blur-md ring-1 ring-white shadow-xl  ";
      ...
      return (
        <div className={`w-full max-w-[210px] rounded-t-2xl p-4 ${glassCls}`}>
           <div className="mb-3 flex items-center justify-between border-b border-slate-100 pb-2">
              ...
              <span className="text-[9px] font-bold text-teal-600">3 Pending</span>
           </div>
           <div className="space-y-2">
              <div className="flex items-center gap-3 rounded-xl bg-teal-50 p-2">
                 <div className="flex flex-col items-center">
                    <span className="text-[7px] font-black text-teal-600">08:30</span>
                    <div className="h-1.5 w-1.5 rounded-full bg-teal-500 animate-pulse" />
                 </div>
                 <div className="flex-1">
                    <p className="text-[9px] font-bold text-slate-900 leading-tight">Maria Santos</p>
                    <p className="text-[7px] text-slate-500 font-medium">Routine Cleaning</p>
                 </div>
              </div>
              <div className="flex items-center gap-3 rounded-xl bg-slate-50 p-2 opacity-70">
                 <span className="text-[7px] font-black text-slate-400">09:15</span>
                 <div className="flex-1">
                    <p className="text-[9px] font-bold text-slate-700">Juan Dela Cruz</p>
        ...
        <div className="flex items-end gap-3 px-4">
           <div className={`w-28 rounded-t-2xl p-3 pb-6 transition-all duration-500 group-hover:-translate-y-2 ${glassCls}`}>
              <div className="flex justify-between items-center mb-2">
                 ...
                 <span className="text-[7px] font-black text-teal-600">LIVE</span>
              </div>
              <div className="space-y-1.5 border-t border-slate-50 pt-2">
                 ...
                 <p className="text-[11px] font-black text-slate-900 tracking-tighter">₱2,450.00</p>
              </div>
              <button className="mt-3 w-full h-5 rounded-md bg-teal-600 text-[7px] font-black text-white shadow-sm">PAY NOW</button>
           </div>
    ...
    case "hmocc":
      return (
        <div className={`w-full max-w-[220px] rounded-t-2xl p-4 ${glassCls}`}>
           ...
           <div className="space-y-2">
              <div className="flex justify-between items-center bg-sky-50/50 p-2 rounded-xl">
                 <div className="flex items-center gap-2">
                    <div className="h-4 w-4 rounded bg-white shadow-sm flex items-center justify-center text-[6px] font-black text-sky-700 leading-none">M</div>
                    <span className="text-[8px] font-bold text-slate-800">Maxicare Claim</span>
                 </div>
                 <span className="text-[7px] font-black bg-sky-500/10 text-sky-600 px-1.5 py-0.5 rounded-full uppercase">Approved</span>
              </div>
              <div className="flex justify-between items-center bg-indigo-50/50 p-2 rounded-xl">
                 <div className="flex items-center gap-2">
                    <div className="h-4 w-4 rounded bg-white shadow-sm flex items-center justify-center text-[6px] font-black text-indigo-700 leading-none">I</div>
                    <span className="text-[8px] font-bold text-slate-800">Intellicare</span>
                 </div>
    ...
    case "xrayflow":
      return (
        <div className="flex items-end gap-3">
           <div className="h-28 w-24 rounded-2xl bg-white p-2 shadow-2xl ring-4 ring-white/10 overflow-hidden relative transition-transform duration-500 group-hover:scale-110">
              ...
              <div className="mt-4 h-full w-full rounded-xl bg-gradient-to-br from-slate-800 to-slate-950 flex flex-col items-center justify-center">
                 <div className="h-12 w-12 rounded-full border-2 border-teal-500/30 bg-teal-500/10 flex items-center justify-center relative">
                    <div className="absolute inset-0 rounded-full border border-teal-500/40 animate-ping" />
                    <svg viewBox="0 0 24 24" fill="none" className="h-6 w-6 text-teal-500 opacity-60">
           ...
           <div className={`h-24 w-32 rounded-t-2xl p-3 ${glassCls}`}>
              <div className="flex items-center gap-1.5 mb-2">
                 <div className="h-3 w-3 rounded-full bg-teal-500/20" />
                 <span className="text-[8px] font-black text-slate-800 uppercase tracking-tighter">Tooth 24 Analysis</span>
              </div>
      ...
      return (
        <div className={`w-full max-w-[230px] rounded-t-2xl p-4 ${glassCls}`}>
           ...
           <div className="grid grid-cols-2 gap-3">
              <div className="rounded-2xl border-2 border-teal-500/30 bg-teal-50/20 p-2.5 relative overflow-hidden group-hover:border-teal-500 transition-colors">
                 <div className="flex justify-between items-start">
                    <span className="text-[7px] font-black text-teal-600 uppercase">Chair 01</span>
                    <span className="h-2 w-2 rounded-full bg-teal-500 animate-pulse" />
                 </div>
                 <p className="mt-1 text-[10px] font-black text-slate-900">In Surgery</p>
                 <p className="text-[7px] text-teal-700/80 font-bold mt-0.5">14m elapsed</p>
              </div>
              <div className="rounded-2xl border-2 border-slate-100 bg-slate-50/50 p-2.5">
...
export function HomePage(): JSX.Element {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-white text-slate-800">
        ...
        <ScrollReveal>
          <div className="rounded-3xl border border-slate-100 bg-white p-5 shadow-sm sm:p-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full border border-teal-200 bg-white px-3 py-1 text-xs font-bold text-teal-700 shadow-sm">
            ...
            <StaggerContainer className="mt-6 grid gap-3 sm:grid-cols-2" stagger={0.08}>
              {localFeatures.map((item) => (
                <StaggerItem key={item}>
                  <div className="flex items-start gap-3 rounded-xl bg-white/80 p-3 shadow-sm ring-1 ring-slate-100">
          ...
          <div className="rounded-3xl border border-slate-100 bg-white p-5 shadow-sm sm:p-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-slate-600">{t("landing.diffSubtitle")}</p>
              </div>
              <span className="inline-flex items-center gap-1.5 rounded-full border border-sky-200 bg-white px-3 py-1 text-xs font-bold text-sky-700 shadow-sm">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {diffProofStats.map((item) => (
                <div key={item.label} className="rounded-xl border border-sky-200/70 bg-sky-50/70 p-3 shadow-sm">
                  <p className="text-lg font-bold text-sky-900">{item.value}</p>
                  <p className="mt-0.5 text-xs font-medium text-sky-800/90">{item.label}</p>
                </div>
              ))}
            </div>
            <div className="mt-3 flex flex-wrap gap-2">
              {diffProofBadges.map((badge) => (
                <span
                  key={badge}
                  className="inline-flex min-h-9 items-center rounded-full border border-slate-200 bg-white/90 px-3 py-1 text-[11px] font-semibold text-slate-700 shadow-sm"
                >
                  {badge}
                </span>
              ))}
            ...
            <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {differentiators.map((item) => (
                <article key={item.title} className="group relative flex flex-col overflow-hidden rounded-[2.5rem] border border-slate-200/80 bg-white/90 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-teal-200 hover:shadow-xl">
                  <div className="p-8">
                    <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-teal-50 text-teal-600 ring-1 ring-teal-100">
                  ...
                  {/* Mini Mockup Area */}
                  <div className="relative mt-auto h-32 overflow-hidden bg-slate-50/50 px-6">
      ...
      <section id="cta" className="scroll-mt-24 relative z-10 pb-12 sm:pb-16 md:pb-20">
        <ScrollReveal>
          <div className="mx-auto max-w-5xl px-4 sm:px-6">
            <motion.div
              className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-teal-600 via-teal-600 to-teal-700 p-6 text-white shadow-2xl sm:p-10 lg:p-12"
            >
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                <form onSubmit={submitEmail} className="mt-10 flex w-full max-w-xl flex-col gap-3 sm:flex-row">
                  ...
                  <button
                    type="submit"
                    className="h-14 rounded-2xl bg-white px-8 text-sm font-black uppercase tracking-widest text-teal-600 transition hover:bg-teal-50 hover:shadow-xl active:scale-95"
                  >
      ...
      {/* FOOTER */}
      <footer className="relative z-10 border-t border-slate-200 bg-white/70 py-10 pb-[max(2.5rem,env(safe-area-inset-bottom))] backdrop-blur sm:py-12">
        <ScrollReveal>
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4">
              <div className="col-span-2 lg:col-span-1">
                ...
                <p className="mt-3 max-w-sm text-sm leading-relaxed text-slate-600">{t("landing.footerTagline")}</p>
              </div>
              {[
                {
                ...
                <div key={col.title}>
                  ...
                  {col.intro ? (
                    <p className="mt-2 max-w-xs text-xs leading-relaxed text-slate-500">{col.intro}</p>
                  ) : null}
                  <ul className="mt-3 space-y-1">
                    {col.links.map((item) => {
                      const isHash = item.to.includes("#");
                      const cls =
                        "flex min-h-11 items-center rounded-lg text-sm font-medium text-slate-600 transition hover:bg-slate-100 hover:text-slate-900   ";
                      return (
