...
export function HmoProvidersPage(): JSX.Element {
  ...
  return (
    <div className="mx-auto max-w-[1200px] space-y-8 px-4 pb-24 sm:px-6 lg:px-8">
      ...
      <div className="rounded-[2.5rem] border border-slate-100 bg-white shadow-2xl shadow-slate-200/50 p-6 overflow-x-auto">
        {isLoading ? (
            ...
            <tbody>
              <AnimatePresence>
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      <input
                        ...
                        className="w-24 rounded-lg border border-slate-200 p-2 text-sm uppercase"
                      />
                    </td>
                    ...
                    <td className="py-3 px-4">
                      <label className="flex items-center gap-2 cursor-pointer">
                        ...
                        />
                        <span className="text-xs font-bold text-slate-600">{t(`${NS}.active`)}</span>
                      </label>
                    </td>
                ...
                {providers.map((p) => {
                  ...
                  return (
                    <motion.tr key={p.id} className="border-b border-slate-100 transition-colors hover:bg-slate-50">
                      <td className="py-4 px-4 font-bold text-slate-900">
                        {p.name}
                        {p.notes && <p className="mt-1 text-xs font-normal text-slate-500">{p.notes}</p>}
                      </td>
                      <td className="py-4 px-4">
                        <span className="rounded-lg bg-slate-100 px-2 py-1 text-xs font-mono font-bold text-slate-600">
                          {p.code}
                        </span>
                      </td>
