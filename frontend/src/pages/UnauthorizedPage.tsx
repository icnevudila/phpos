...
export function UnauthorizedPage(): JSX.Element {
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-slate-50 dark:bg-slate-950">
      ...
      >
        <p className="text-sm font-semibold uppercase tracking-wider text-amber-600 dark:text-amber-400">403</p>
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white">{t("pages.unauthorized.title")}</h1>
        <p className="max-w-md text-slate-600 dark:text-slate-400">{t("pages.unauthorized.message")}</p>
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            to="/"
            className="rounded-lg border border-slate-300 bg-white px-5 py-2.5 text-sm font-semibold text-slate-800 shadow-sm hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:hover:bg-slate-800 dark:ring-offset-slate-950"
          >
