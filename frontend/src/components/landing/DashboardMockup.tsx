    ...
    <div className="relative group mx-auto max-w-[1300px]">
      ...
      <div className="rounded-[2.5rem] border-[1px] border-slate-200 bg-white shadow-dent-premium p-2 overflow-hidden relative">
        ...
        <div className="bg-[#f8fafc] h-[650px] flex overflow-hidden font-sans">
          ...
          {/* Sidebar */}
          <div className="w-64 bg-white border-r border-slate-200 p-6 flex flex-col gap-6 shrink-0">
             ...
             <div className="space-y-1">
                {[
                   ...
                   <div key={item.n} className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-[11px] font-bold uppercase tracking-widest transition-all cursor-pointer ${item.a ? 'bg-medical-gradient text-white shadow-lg shadow-teal-500/20' : 'text-slate-500 hover:text-white'}`}>
