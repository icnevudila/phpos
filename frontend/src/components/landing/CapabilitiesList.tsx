...
export function CapabilitiesList(): JSX.Element {
  ...
  const rows: Row[] = [
    {
      ...
      title: t("landing.cap1Title", { defaultValue: "Cap1 Title" }),
      desc: t("landing.cap1Desc", { defaultValue: "Cap1 Desc" }),
    ...
    },
    {
      ...
      title: t("landing.cap2Title", { defaultValue: "Cap2 Title" }),
      desc: t("landing.cap2Desc", { defaultValue: "Cap2 Desc" }),
      accent: "text-sky-600 bg-sky-50 ring-sky-100",
    },
    {
      icon: <I d="M14 3h7v7M10 14 21 3M21 14v7h-7M3 10V3h7M3 21l7-7" />,
      title: t("landing.cap3Title", { defaultValue: "Cap3 Title" }),
      desc: t("landing.cap3Desc", { defaultValue: "Cap3 Desc" }),
      accent: "text-teal-600 bg-teal-50 ring-teal-100",
    },
    {
      icon: <I d="M2 4h20v16H2zM2 9h20M6 14h4M6 17h2" />,
      title: t("landing.cap4Title", { defaultValue: "Cap4 Title" }),
      desc: t("landing.cap4Desc", { defaultValue: "Cap4 Desc" }),
    ...
    },
    {
      ...
      title: t("landing.cap6Title", { defaultValue: "Cap6 Title" }),
      desc: t("landing.cap6Desc", { defaultValue: "Cap6 Desc" }),
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
      <div>
        <SectionEyebrow label={t("landing.capEyebrow", { defaultValue: "Cap Eyebrow" })} icon={IconGrid} accent="emerald" />
        <h2 className="mt-3 text-3xl font-bold tracking-tight text-brand-text sm:text-4xl">
          {t("landing.capTitle", { defaultValue: "Cap Title" })}
        </h2>
        <p className="mt-4 text-brand-muted">{t("landing.capSubtitle", { defaultValue: "Cap Subtitle" })}</p>
        <div className="mt-6 inline-flex items-center gap-2 rounded-full bg-brand-surface px-4 py-2 text-xs font-semibold text-white">
          ...
          {t("landing.capCloud", { defaultValue: "Cap Cloud" })}
        </div>
      </div>
