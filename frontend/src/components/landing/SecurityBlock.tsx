  ...
  const items = [
    {
      ...
      title: t("landing.sec1Title", { defaultValue: "Sec1 Title" }),
      desc: t("landing.sec1Desc", { defaultValue: "Sec1 Desc" }),
    ...
    },
    {
      ...
      title: t("landing.sec2Title", { defaultValue: "Sec2 Title" }),
      desc: t("landing.sec2Desc", { defaultValue: "Sec2 Desc" }),
    ...
    },
    {
      ...
      title: t("landing.sec3Title", { defaultValue: "Sec3 Title" }),
      desc: t("landing.sec3Desc", { defaultValue: "Sec3 Desc" }),
    ...
    },
    {
      ...
      title: t("landing.sec4Title", { defaultValue: "Sec4 Title" }),
      desc: t("landing.sec4Desc", { defaultValue: "Sec4 Desc" }),
    ...
    },
    {
      ...
      title: t("landing.sec5Title", { defaultValue: "Sec5 Title" }),
      desc: t("landing.sec5Desc", { defaultValue: "Sec5 Desc" }),
    ...
    },
    {
      ...
      title: t("landing.sec6Title", { defaultValue: "Sec6 Title" }),
      desc: t("landing.sec6Desc", { defaultValue: "Sec6 Desc" }),
    ...
    <div>
      <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div className="lg:sticky lg:top-28">
          <SectionEyebrow label={t("landing.secEyebrow", { defaultValue: "Sec Eyebrow" })} icon={IconShield} accent="emerald" />
          <h2 className="mt-3 text-3xl font-black tracking-tight text-brand-text sm:text-4xl">
            {t("landing.secTitle", { defaultValue: "Sec Title" })}
          </h2>
          <p className="mt-4 text-lg font-medium text-brand-muted">{t("landing.secSubtitle", { defaultValue: "Sec Subtitle" })}</p>
          <div className="mt-8 rounded-[2.5rem] border border-brand-border bg-gradient-to-br from-slate-50 to-white p-8 shadow-sm">
            <p className="text-xs font-black uppercase tracking-[0.2em] text-teal-700">
              {t("landing.secPromiseLabel", { defaultValue: "Sec Promise Label" })}
            </p>
            <p className="mt-4 text-base leading-relaxed text-brand-text">
              {t("landing.secPromise", { defaultValue: "Sec Promise" })}
            </p>
          </div>
        </div>
