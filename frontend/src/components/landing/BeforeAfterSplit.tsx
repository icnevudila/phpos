...
function BeforeSide(): JSX.Element {
  ...
  return (
    <div className="relative flex flex-col gap-3 overflow-hidden rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-inner">
      ...
      <div className="relative mt-2 inline-flex items-center gap-1.5 self-start rounded-full border border-rose-200 bg-white py-1 pl-1 pr-3 text-[10px] font-bold uppercase tracking-[0.18em] text-rose-700 shadow-sm">
...
function AfterSide(): JSX.Element {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-teal-200 bg-gradient-to-br from-white to-teal-50/40 p-6 shadow-xl">
      <div className="relative inline-flex items-center gap-1.5 rounded-full border border-teal-200 bg-white py-1 pl-1 pr-3 text-[10px] font-bold uppercase tracking-[0.18em] text-teal-700 shadow-[0_2px_6px_-2px_rgba(16,185,129,0.3)]">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        {[
          ...
          <span
            key={x}
            className="inline-flex items-center gap-1 rounded-full bg-white px-2.5 py-1 text-[10px] font-bold text-slate-700 shadow-sm ring-1 ring-teal-100"
          >
  ...
  return (
    <div>
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-slate-600">{t("landing.baSubtitle")}</p>
      </div>
      ...
      <div className="mt-10 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        <div className="grid grid-cols-[1fr_auto_1fr] divide-x divide-slate-100 text-sm">
          ...
          <div className="bg-slate-100 px-3 py-3 text-center">→</div>
          ...
          {rows.map((r, i) => (
            <div key={i} className="contents">
              <motion.div
                ...
                className="px-5 py-3 text-slate-500 line-through"
              >
                {r.before}
              </motion.div>
              <div className="flex items-center justify-center bg-slate-50 px-3 text-slate-400">
                →
              </div>
              <motion.div
                initial={{ opacity: 0, x: 12 }}
