...
export function AppTopbar({ profile, onOpenDrawer }: AppTopbarProps): JSX.Element {
  ...
  return (
    <header
      className="sticky top-0 z-30 flex min-h-14 items-center gap-2 border-b border-slate-200/90 bg-white/95 px-3 py-2 shadow-[0_1px_0_0_rgba(15,23,42,0.03)] backdrop-blur-md supports-[backdrop-filter]:bg-white/80 sm:gap-3 sm:px-4 md:min-h-16 md:px-6"
      style={{
