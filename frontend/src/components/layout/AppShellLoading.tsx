...
export function AppShellLoading(): JSX.Element {
  ...
  return (
    <div
      ...
      aria-live="polite"
    >
      <div className="relative flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-500 to-teal-600 shadow-lg shadow-teal-900/20">
      ...
      <div className="flex gap-1.5" aria-hidden>
        {[0, 1, 2].map((i) => (
          <span
            key={i}
            className="h-2 w-2 rounded-full bg-teal-500/80 animate-bounce"
