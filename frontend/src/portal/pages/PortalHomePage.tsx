    ...
    <div className="min-w-0 space-y-5 px-4 pt-5">
      ...
      <section className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <p className="relative text-[11px] text-slate-500">{t("pages.portal.home.bookCardSub")}</p>
        </Link>
        <Link
        ...
        >
          ...
          <p className="relative text-[11px] text-slate-500">{t("pages.portal.home.historyCardSub")}</p>
        </Link>
      </section>
        ...
        <section>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            {Number(home.lastInvoice.remaining) > 0 ? (
              ...
              <p className="mt-1 text-xs text-teal-700">{t("pages.portal.home.paidFull")}</p>
            )}
            <Link
              to={`/${slug}/portal/history${kioskSuffix}`}
